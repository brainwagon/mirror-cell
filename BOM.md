...
Generated by `mirror_cell.py --aperture 6`, which writes it to
`build/` and commits this copy as `BOM.md`. Every number comes from the
...
For a 6" × 1" mirror in a 7.5" ID tube.
...
250–255 °C, bed 100–110 °C, **enclosure closed, part cooling 0–20 %**, 10 mm brim.
